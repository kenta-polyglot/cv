...
- バックエンドの多種多様な言語・DB・フレームワークを用いた豊富な開発経験があり、AWSとGCPの様々なマネージドサービスに精通しています。(一応AndroidアプリとiOSアプリの開発経験もあります。元々はWindows系のエンジニアなので.NET系の開発経験も豊富ですが現在はLinuxプラットフォームでの開発がメインです)
